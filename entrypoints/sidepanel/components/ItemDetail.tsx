...
export default function ItemDetail({ itemId, categories, tags, onClose, onAnalyze }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-20 flex flex-col bg-white dark:bg-neutral-950">
      ...
      {toast && (
        <div className="pointer-events-none absolute bottom-4 left-1/2 -translate-x-1/2 rounded-full bg-neutral-900 px-3 py-1.5 text-[11px] text-white shadow-lg dark:bg-neutral-100 dark:text-ink">
          {toast}
        </div>
      )}
    </div>
